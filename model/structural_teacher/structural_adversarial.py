# model/structural_adversarial.py
...
class StructuralAdversarialModel(nn.Module):
    """
    Structural adversarial debiasing model consisting of a GNN backbone (readout_type='none')
    and an MLP discriminator for adversarial learning of head/tail groups.
    """
